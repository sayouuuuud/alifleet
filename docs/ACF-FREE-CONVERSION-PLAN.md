...
> التحويل **اتعمل خلاص** في `wordpress/acf/alifleet-acf-schema.json`. لو انت agent: اقرأه لو محتاج تفهم رسالة خطأ من المدقّق أو سكربت الاستيراد، و**ممنوع** تعدّل الـ schema أو الـ seed بناءً عليه. لقيت غلط؟ بلّغ وقف. خطتك في `AGENT-RUNBOOK.md`.
