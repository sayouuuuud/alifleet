...
اليوزر بياخد **sudo محدود بقايمة** — الملف الجاهز في `wordpress/server/alifleet-agent.sudoers`.
القايمة دي **الطبقة التانية** للحماية، والطبقة الأولى هي الجدول اللي فوق. لو أمر عدّى من الـ sudoers ومخالف للجدول → **مخالفة**.
