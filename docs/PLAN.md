...
> الملف ده خطة تنفيذية. كل بند فيه: **إيه المشكلة → إيه اللي هعمله → الملف الناتج**.
> اكتب ملاحظاتك جنب أي بند قبل ما أبدأ لو عايز تغيّر حاجة.
...
| # | المخرج | الحالة |
|---|---|---|
| 1 | `wordpress/acf/alifleet-acf-schema.json` — 10 groups / 453 حقل | ✅ |
